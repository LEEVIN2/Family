...
<div class="row3">
<c:choose>
    <c:when test="${fn:length(boardDTO.content) > 40}">
        ${fn:substring(boardDTO.content, 0, 40)}...
    </c:when>
    <c:otherwise>
        ${boardDTO.content}
    </c:otherwise>
...
<a href="${pageContext.request.contextPath}/board/home"><img src="${pageContext.request.contextPath}/resources/img/board/home_push.png" alt="home_push"></a>
